...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-user">
            ...
            <a href="<?= BASE_URL ?>/super/logout" class="btn-logout">Salir</a>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="hotels-section">
            <div class="section-header">
                ...
                <a href="<?= BASE_URL ?>/super/hotels/create" class="btn-primary">➕ Crear Nuevo Hotel</a>
            </div>
            ...
            <?php if (empty($hotels)): ?>
                <div class="empty-state">
                    ...
                    <br>
                    <a href="<?= BASE_URL ?>/super/hotels/create" class="btn-primary">➕ Crear Primer Hotel</a>
                </div>
            <?php else: ?>
