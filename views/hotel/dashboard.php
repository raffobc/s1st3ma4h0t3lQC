...
<div class="container">
    <div class="dashboard-header">
        <div>
            ...
            <p class="subtitle">Aqui esta un resumen general del hotel</p>
        </div>
        <a href="<?= BASE_URL ?>/hotel/estadisticas" class="btn-primary">Ver Estadisticas</a>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-icon primary">H</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-icon success">D</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-icon danger">O</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                <div>
                    ...
                    <div class="stat-label">Tasa de Ocupacion</div>
                </div>
        ...
        <div class="card">
            ...
            <?php if (empty($recentReservations)): ?>
                <div class="empty-state">
                    ...
                    <p style="font-size: 12px; margin-top: 10px;">Las reservas apareceran aqui cuando se creen</p>
                </div>
            <?php else: ?>
                <table class="table">
                    <thead>
