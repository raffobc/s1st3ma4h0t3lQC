<?php
/**
 * CREAR VISTA COMPLETA DEL DASHBOARD DEL HOTEL
 * Archivo: C:\xampp\htdocs\hotel-system\create_dashboard_view.php
 * Accede a: http://localhost/hotel-system/create_dashboard_view.php
 */
...
// Guardar la vista
$viewPath = $baseDir . '/views/hotel/dashboard.php';
...
if (file_put_contents($viewPath, $dashboardHTML)) {
    $success = true;
} else {
...
<body>
    <div class="container">
        <?php if (isset($success)): ?>
            <div class="icon">🎉</div>
            <h1>¡Dashboard Completo Creado!</h1>
            
            <div class="success-box">
                <strong>✅ La vista del dashboard se creó exitosamente</strong><br><br>
                Archivo creado: <code>views/hotel/dashboard.php</code>
            </div>
            
            <div class="features">
                <h3 style="margin-bottom: 15px;">📊 Características del Dashboard:</h3>
                <ul>
                    <li>✅ 6 tarjetas de estadísticas en tiempo real</li>
                    <li>✅ Total de habitaciones</li>
                    <li>✅ Habitaciones disponibles/ocupadas</li>
                    <li>✅ Tasa de ocupación automática</li>
                    <li>✅ Reservas activas</li>
                    <li>✅ Ingresos del mes</li>
                    <li>✅ Lista de reservas recientes</li>
                    <li>✅ Estado de habitaciones por tipo</li>
                    <li>✅ Diseño responsive (móvil y desktop)</li>
            ...
            <div style="margin-top: 30px; padding: 20px; background: #fffbeb; border-radius: 8px; text-align: left;">
                <h3 style="margin-bottom: 10px;">🎯 Siguiente Paso:</h3>
                <p style="line-height: 1.6;">
                    1. Inicia sesión con las credenciales del hotel<br>
                    2. Verás el dashboard completo con todas las estadísticas<br>
                    3. Por ahora verás 0 en todo (normal, aún no hay datos)<br>
                    4. Próximo: Crear módulo de <strong>Gestión de Habitaciones</strong>
                </p>
            </div>
        ...
        <?php else: ?>
            <div class="icon">❌</div>
            <h1>Error</h1>
            <div style="background: #fee2e2; border-left: 4px solid #ef4444; padding: 20px; border-radius: 8px; margin: 20px 0; color: #991b1b;">
